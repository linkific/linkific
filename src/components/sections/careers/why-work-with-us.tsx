  ...
  return (
    <section id="why-work-with-us" className="py-16">
      <div className="max-w-3xl mx-auto text-center mb-12">
        <h2 className="text-3xl font-bold text-off-white">Why Work With Us?</h2>
        <p className="text-sky-blue/70 mt-2">We invest in our people. Here’s what you can expect when you join our team.</p>
      </div>
